...
CREATE TABLE IF NOT EXISTS `shoe` (
  ...
  `brand_id` INT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_shoe_type1_idx` (`type_id` ASC) ,
  INDEX `fk_shoe_brand1_idx` (`brand_id` ASC) ,
...
CREATE TABLE IF NOT EXISTS `inventory_item` (
  ...
  `shoe_id` INT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_inventory_item_shoe1_idx` (`shoe_id` ASC) ,
...
CREATE TABLE IF NOT EXISTS `cart_has_inventory_item` (
  ...
  INDEX `fk_cart_has_inventory_item_inventory_item1_idx` (`inventory_item_id` ASC) ,
  INDEX `fk_cart_has_inventory_item_cart1_idx` (`cart_id` ASC) ,
